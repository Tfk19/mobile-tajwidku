...
import { Center,Box, View, Text } from "@gluestack-ui/themed";
import { Header } from "../components";
import React, { useState, useEffect } from "react";
import questions from '../soal1';
...
const Soal1 = () => {
  ...
  const koreksiJawaban = (jawabanDipilih) => {
    if (sound) {
      sound.playAsync();
    }
    if (jawabanDipilih === questions[pertanyaan].jawabanBenar) {
      skors(skor + 1);
    }
